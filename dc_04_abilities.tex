...
\begin{enumerate}[label={[\arabic*]},leftmargin=0.5cm]
    ...
    \setlength{\parskip}{0cm} % 段落間
    \setlength{\itemsep}{0cm} % 項目間
    \paper{Virtual Secure Platform: A {Five-Stage} Pipeline Processor over {TFHE}}{Kotaro Matsuoka, \etal}{30th USENIX Security Symposium (\amikake{\textbf{USENIX Security}} 21)}{}{pp.4007--4024}{Online, 2021年8月}\label{paper:usenix}
